...
La propuesta de proyecto software está dividida en etapas. Cada etapa tiene una serie de herramientas y conocimientos que representan estas herramientas. Por ejemplo, en la etapa de 'Desarrollo frontend', 'Framework Frontend' es una herramienta y 'React' es el conocimiento que representa esta herramienta.

Tienes 3 posibles opciones: 
- INICIAL: empezar la propuesta de nuevo. Elegirla en caso de que el feedback requiera reestructurar las etapas del proyecto. Por ejemplo, si el feedback dice algo como "Fusionar las dos primeras etapas"
- DEFINIR_HERRAMIENTAS_DE_ETAPAS: modificar las herramientas de las etapas del proyecto. Elegirla en caso de que el feedback requiera cambiar el tipo de herramientas de las etapas del proyecto. Por ejemplo, si el feedback dice algo como "No utilizar un framework backend en la etapa X".
- DEFINIR_CONOCIMIENTOS: modificar los conocimientos de las etapas del proyecto. Elegirla en caso de que el feedback requiera cambiar el tipo de conocimientos de las etapas del proyecto. Por ejemplo, si el feedback dice algo como "Cambiar el conocimiento de React por Angular en la etapa X".
